...
var Side = (function () {
    function Side(side) {
        ...
        this.isBoulderBadge = !!side.isBoulderBadge;
        this.isThunderBadge = !!side.isThunderBadge;
        this.isSoulBadge = !!side.isSoulBadge;
        this.isVolcanoBadge = !!side.isVolcanoBadge;
