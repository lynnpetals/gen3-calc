...
exports.Species = exports.HACK_SPECIES = exports.SPECIES = void 0;
...
var EK_PATCH = {
    Abra: { expYield: 73 },
    Aerodactyl: { abilities: { 0: 'Pressure' }, expYield: 202 },
    Alakazam: { bs: { sd: 95 }, expYield: 186 },
    Arbok: { bs: { at: 95 }, expYield: 147 },
    Arcanine: { expYield: 213 },
    Articuno: { bs: { sa: 115 }, expYield: 215 },
    Beedrill: { bs: { at: 90 }, expYield: 159 },
    Bellsprout: { expYield: 84 },
    Blastoise: { expYield: 210 },
    Bulbasaur: { expYield: 64 },
    Butterfree: { bs: { sa: 90 }, expYield: 160 },
    Caterpie: { expYield: 53 },
    Chansey: { bs: { df: 25 }, expYield: 1 },
    Charizard: { expYield: 209 },
    Charmander: { expYield: 65 },
    Charmeleon: { expYield: 142 },
    Clefable: { bs: { sa: 95 }, expYield: 129 },
    Clefairy: { expYield: 68 },
    Cloyster: { bs: { sd: 70 }, expYield: 203 },
    Cubone: { abilities: { 0: 'Lightning Rod' }, expYield: 87 },
    Dewgong: { abilities: { 0: 'Swift Swim' }, bs: { sa: 95 }, expYield: 176 },
    Diglett: { abilities: { 0: 'Arena Trap' }, expYield: 81 },
    Ditto: { bs: { hp: 100, at: 100, df: 100, sa: 100, sd: 100, sp: 100 }, expYield: 61 },
    Dodrio: { bs: { sp: 110 }, expYield: 158 },
    Doduo: { expYield: 96 },
    Dragonair: { expYield: 144 },
    Dragonite: { expYield: 218 },
    Dratini: { expYield: 67 },
    Drowzee: { expYield: 102 },
    Dugtrio: { bs: { at: 100 }, expYield: 153 },
    Eevee: { expYield: 92 },
    Ekans: { expYield: 62 },
    Electabuzz: { expYield: 156 },
    Electrode: { bs: { sp: 150 }, expYield: 150 },
    Exeggcute: { expYield: 98 },
    Exeggutor: { bs: { sd: 85 }, expYield: 212 },
    'Farfetch\u2019d': { bs: { at: 90 }, expYield: 94 },
    Fearow: { expYield: 162 },
    Flareon: { abilities: { 0: 'Flame Body' }, expYield: 198 },
    Gastly: { expYield: 95 },
    Gengar: { bs: { at: 75 }, expYield: 190 },
    Geodude: { expYield: 86 },
    Gloom: { expYield: 132 },
    Golbat: { expYield: 171 },
    Goldeen: { expYield: 111 },
    Golduck: { expYield: 174 },
    Golem: { bs: { at: 120 }, expYield: 177 },
    Graveler: { expYield: 134 },
    Grimer: { expYield: 90 },
    Growlithe: { expYield: 91 },
    Gyarados: { expYield: 214 },
    Haunter: { expYield: 126 },
    Hitmonchan: { abilities: { 0: 'Guts' }, expYield: 140 },
    Hitmonlee: { expYield: 139 },
    Horsea: { expYield: 83 },
    Hypno: { bs: { sa: 115 }, expYield: 165 },
    Ivysaur: { expYield: 141 },
    Jigglypuff: { expYield: 76 },
    Jolteon: { abilities: { 0: 'Static' }, expYield: 197 },
    Jynx: { expYield: 137 },
    Kabuto: { expYield: 119 },
    Kabutops: { expYield: 201 },
    Kadabra: { expYield: 145 },
    Kakuna: { expYield: 71 },
    Kangaskhan: { expYield: 175 },
    ...
    Mankey: { expYield: 74 },
    Marowak: { bs: { at: 90 }, expYield: 124 },
    Meowth: { abilities: { 0: 'Limber' }, expYield: 69 },
    Metapod: { expYield: 72 },
    Mew: { expYield: 64 },
    Mewtwo: { expYield: 255 },
    Moltres: { bs: { at: 120 }, expYield: 217 },
    'Mr. Mime': { expYield: 136 },
    Muk: { expYield: 157 },
    Nidoking: { bs: { at: 102 }, expYield: 195 },
    Nidoqueen: { bs: { at: 92 }, expYield: 194 },
    'Nidoran-F': { expYield: 59 },
    'Nidoran-M': { expYield: 60 },
    Nidorina: { expYield: 117 },
    Nidorino: { expYield: 118 },
    Ninetales: { abilities: { 0: 'Pressure' }, bs: { sa: 100 }, expYield: 178 },
    Oddish: { expYield: 78 },
    Omanyte: { expYield: 120 },
    ...
    Pidgey: { expYield: 55 },
    Pikachu: { bs: { df: 40, sd: 50 }, expYield: 82 },
    Pinsir: { abilities: { 0: 'Intimidate' }, expYield: 200 },
    Poliwag: { abilities: { 0: 'Swift Swim' }, expYield: 77 },
    Poliwhirl: { abilities: { 0: 'Swift Swim' }, expYield: 131 },
    Poliwrath: { abilities: { 0: 'Swift Swim' }, bs: { at: 95 }, expYield: 185 },
    Ponyta: { expYield: 152 },
    Porygon: { expYield: 130 },
    Primeape: { expYield: 149 },
    Psyduck: { expYield: 80 },
    Raichu: { bs: { sp: 110 }, expYield: 122 },
    Rapidash: { expYield: 192 },
    Raticate: { expYield: 116 },
    Rattata: { expYield: 57 },
    Rhydon: { expYield: 204 },
    Rhyhorn: { expYield: 135 },
    Sandshrew: { expYield: 93 },
    Sandslash: { expYield: 163 },
    Scyther: { expYield: 187 },
    Seadra: { expYield: 155 },
    Seaking: { expYield: 170 },
    Seel: { expYield: 100 },
    Shellder: { expYield: 97 },
    Slowbro: { abilities: { 0: 'Shell Armor' }, expYield: 164 },
    Slowpoke: { abilities: { 0: 'Shell Armor' }, expYield: 99 },
    Snorlax: { abilities: { 0: 'Guts' }, expYield: 154 },
    Spearow: { expYield: 58 },
    Squirtle: { expYield: 66 },
    Starmie: { bs: { sd: 100 }, expYield: 207 },
    Staryu: { expYield: 106 },
    Tangela: { bs: { sd: 100 }, expYield: 166 },
    Tauros: { expYield: 211 },
    Tentacool: { expYield: 105 },
    Tentacruel: { bs: { sa: 100 }, expYield: 205 },
    Vaporeon: { abilities: { 0: 'Swift Swim' }, expYield: 196 },
    Venomoth: { expYield: 138 },
    Venonat: { expYield: 75 },
    Venusaur: { expYield: 208 },
    ...
    Weezing: { bs: { sd: 85 }, expYield: 173 },
    Wigglytuff: { bs: { at: 80, sa: 85 }, expYield: 109 },
    Zapdos: { bs: { at: 95, df: 90, sd: 95, sp: 105 }, expYield: 216 },
    Zubat: { expYield: 54 },
    Aipom: { expYield: 94 },
    Ampharos: { bs: { df: 85 }, expYield: 194 },
    Ariados: { bs: { sd: 70 }, expYield: 134 },
    Azumarill: { abilities: { 0: 'Huge Power' }, bs: { at: 60, sa: 60 }, expYield: 153 },
    Bayleef: { expYield: 141 },
    Bellossom: { bs: { df: 95 }, expYield: 184 },
    Blissey: { bs: { at: 5, df: 35, sd: 115 }, expYield: 1 },
    Celebi: { expYield: 64 },
    Chikorita: { expYield: 64 },
    Chinchou: { expYield: 90 },
    Cleffa: { expYield: 37 },
    Corsola: { bs: { hp: 65, df: 95, sd: 95 }, expYield: 113 },
    Crobat: { expYield: 204 },
    Croconaw: { expYield: 143 },
    Cyndaquil: { expYield: 65 },
    Delibird: { expYield: 183 },
    Donphan: { expYield: 189 },
    Dunsparce: { expYield: 75 },
    Elekid: { expYield: 106 },
    Entei: { bs: { sa: 110 }, expYield: 217 },
    Espeon: { expYield: 197 },
    Feraligatr: { expYield: 210 },
    Flaaffy: { expYield: 117 },
    Forretress: { expYield: 118 },
    Furret: { expYield: 116 },
    Girafarig: { expYield: 149 },
    Gligar: { expYield: 108 },
    Granbull: { expYield: 178 },
    Heracross: { expYield: 200 },
    Hitmontop: { expYield: 138 },
    'Ho-Oh': { expYield: 220 },
    Hoothoot: { expYield: 58 },
    Hoppip: { expYield: 74 },
    Houndoom: { bs: { sa: 130, sp: 110 }, expYield: 204 },
    Houndour: { expYield: 114 },
    Igglybuff: { expYield: 39 },
    Jumpluff: { bs: { sd: 95 }, expYield: 176 },
    ...
    Lugia: { expYield: 220 },
    Magby: { expYield: 117 },
    Magcargo: { bs: { hp: 60, sa: 90 }, expYield: 154 },
    Mantine: { bs: { hp: 85 }, expYield: 168 },
    Mareep: { expYield: 59 },
    Marill: { expYield: 58 },
    ...
    Phanpy: { expYield: 124 },
    Pichu: { expYield: 42 },
    Piloswine: { bs: { sa: 70, sd: 60, sp: 60 }, expYield: 160 },
    Pineco: { expYield: 60 },
    Politoed: { abilities: { 0: 'Swift Swim' }, expYield: 185 },
    Porygon2: { expYield: 180 },
    Pupitar: { expYield: 144 },
    Quagsire: { expYield: 137 },
    Quilava: { expYield: 142 },
    Qwilfish: { bs: { df: 85, sa: 75, sd: 65 }, expYield: 100 },
    Raikou: { bs: { df: 95 }, expYield: 216 },
    Remoraid: { expYield: 78 },
    Scizor: { expYield: 200 },
    Sentret: { expYield: 57 },
    Shuckle: { bs: { hp: 50, at: 15, sa: 5 }, expYield: 80 },
    Skarmory: { expYield: 168 },
    Skiploom: { expYield: 136 },
    Slowking: { expYield: 164 },
    Slugma: { expYield: 78 },
    ...
    Steelix: { expYield: 196 },
    Sudowoodo: { expYield: 135 },
    Suicune: { bs: { hp: 120 }, expYield: 215 },
    Sunflora: { expYield: 146 },
    Sunkern: { expYield: 52 },
    Swinub: { expYield: 78 },
    Teddiursa: { expYield: 124 },
    Togepi: { expYield: 74 },
    ...
    Altaria: { expYield: 188 },
    Anorith: { expYield: 119 },
    Armaldo: { expYield: 200 },
    Aron: { expYield: 96 },
    Azurill: { abilities: { 0: 'Huge Power' }, expYield: 33 },
    Bagon: { expYield: 89 },
    Baltoy: { expYield: 58 },
    Banette: { expYield: 179 },
    Barboach: { expYield: 92 },
    Beautifly: { bs: { sa: 100 }, expYield: 161 },
    Beldum: { expYield: 103 },
    Blaziken: { expYield: 209 },
    Breloom: { expYield: 165 },
    Cacnea: { expYield: 97 },
    Cacturne: { expYield: 177 },
    Camerupt: { expYield: 175 },
    Carvanha: { expYield: 88 },
    Cascoon: { expYield: 72 },
    Castform: { bs: { hp: 75, at: 110, df: 75, sa: 110, sd: 75, sp: 100 }, expYield: 145 },
    'Castform-Rainy': { bs: { hp: 75, at: 110, df: 75, sa: 110, sd: 75, sp: 100 }, expYield: 145 },
    'Castform-Snowy': { bs: { hp: 75, at: 110, df: 75, sa: 110, sd: 75, sp: 100 }, expYield: 145 },
    'Castform-Sunny': { bs: { hp: 75, at: 110, df: 75, sa: 110, sd: 75, sp: 100 }, expYield: 145 },
    Chimecho: { bs: { hp: 75, df: 80, sd: 90 }, expYield: 147 },
    Clamperl: { expYield: 142 },
    Claydol: { expYield: 189 },
    Combusken: { expYield: 142 },
    Corphish: { expYield: 111 },
    Cradily: { expYield: 201 },
    ...
    Duskull: { expYield: 97 },
    Dustox: { expYield: 160 },
    Electrike: { expYield: 104 },
    Exploud: { expYield: 184 },
    Feebas: { expYield: 61 },
    Flygon: { expYield: 197 },
    Gardevoir: { bs: { hp: 70, df: 75, sp: 90 }, expYield: 208 },
    Glalie: { bs: { at: 100, sa: 100, sp: 100 }, expYield: 187 },
    Gorebyss: { expYield: 178 },
    Groudon: { abilities: { 0: 'Run Away' }, expYield: 218 },
    Grovyle: { expYield: 141 },
    Grumpig: { expYield: 164 },
    Gulpin: { expYield: 75 },
    Hariyama: { expYield: 184 },
    Huntail: { expYield: 178 },
    Illumise: { bs: { df: 75, sd: 85 }, expYield: 146 },
    Jirachi: { expYield: 215 },
    Kecleon: { expYield: 132 },
    Kirlia: { expYield: 140 },
    Kyogre: { abilities: { 0: 'Run Away' }, expYield: 218 },
    Lairon: { expYield: 152 },
    Latias: { expYield: 211 },
    Latios: { expYield: 211 },
    Lileep: { expYield: 121 },
    Linoone: { expYield: 128 },
    Lombre: { expYield: 141 },
    Lotad: { expYield: 74 },
    Loudred: { expYield: 126 },
    Ludicolo: { expYield: 181 },
    Lunatone: { bs: { hp: 90 }, expYield: 150 },
    Luvdisc: { expYield: 110 },
    Makuhita: { expYield: 87 },
    Manectric: { expYield: 168 },
    Marshtomp: { expYield: 143 },
    Masquerain: { bs: { sa: 100 }, expYield: 128 },
    Mawile: { expYield: 98 },
    Medicham: { expYield: 153 },
    Meditite: { expYield: 91 },
    Metagross: { expYield: 210 },
    Metang: { expYield: 153 },
    Mightyena: { expYield: 128 },
    Milotic: { expYield: 213 },
    Minun: { expYield: 120 },
    Mudkip: { expYield: 65 },
    Nincada: { expYield: 65 },
    Ninjask: { expYield: 155 },
    Nosepass: { expYield: 108 },
    Numel: { expYield: 88 },
    Nuzleaf: { expYield: 141 },
    Pelipper: { bs: { sa: 95 }, expYield: 164 },
    Plusle: { expYield: 120 },
    Poochyena: { expYield: 55 },
    Ralts: { expYield: 70 },
    Rayquaza: { expYield: 255 },
    Regice: { bs: { sa: 120 }, expYield: 216 },
    Regirock: { bs: { at: 120 }, expYield: 217 },
    ...
    Sealeo: { expYield: 128 },
    Seedot: { expYield: 74 },
    Seviper: { expYield: 165 },
    Sharpedo: { expYield: 175 },
    Shedinja: { bs: { at: 110, df: 35, sd: 20 }, expYield: 95 },
    Shelgon: { expYield: 144 },
    Shiftry: { expYield: 181 },
    Shroomish: { expYield: 65 },
    Shuppet: { expYield: 97 },
    Silcoon: { expYield: 71 },
    Skitty: { expYield: 65 },
    Slaking: { expYield: 210 },
    Slakoth: { expYield: 83 },
    Snorunt: { expYield: 74 },
    Solrock: { bs: { hp: 90 }, expYield: 150 },
    Spheal: { expYield: 75 },
    Spinda: { bs: { hp: 80, at: 80, df: 80, sa: 80, sd: 80, sp: 80 }, expYield: 85 },
    Spoink: { expYield: 89 },
    Surskit: { expYield: 63 },
    Swablu: { expYield: 74 },
    Swalot: { expYield: 168 },
    Swampert: { expYield: 210 },
    Swellow: { bs: { sa: 75 }, expYield: 162 },
    Taillow: { expYield: 59 },
    Torchic: { expYield: 65 },
    Torkoal: { expYield: 161 },
    Trapinch: { expYield: 73 },
    Treecko: { expYield: 65 },
    Tropius: { expYield: 169 },
    Vibrava: { expYield: 126 },
    Vigoroth: { expYield: 126 },
    Volbeat: { bs: { df: 75, sd: 85 }, expYield: 146 },
    Wailmer: { expYield: 137 },
    Wailord: { bs: { hp: 160, at: 110, df: 64, sa: 110, sd: 110, sp: 1 }, expYield: 206 },
    Walrein: { expYield: 192 },
    Whiscash: { expYield: 158 },
    Whismur: { expYield: 68 },
    Wingull: { expYield: 64 },
    Wurmple: { expYield: 54 },
    Wynaut: { expYield: 44 },
    Zangoose: { expYield: 165 },
